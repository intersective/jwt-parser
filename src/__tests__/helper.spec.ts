...
describe('2. parse tests', () => {
  describe('2.1 test parse when service is PRACTERA', () => {
    it('2.1.1 it should throw error', () => {
      try {
        parse(
  ...
  describe('2.4 test parse when service is PRACTERA', () => {
    ...
    it('2.4.2 it should throw error if it is live environment with "CHECK_JWT_EXPIRY=true"', () => {
      // sign with RSA SHA256
      try {
        parse(
          'ewoJInR5cGUiOiAiSldUIiwKCSJhbGciOiAiUlMyNTYiCn0.' +
    ...
    it('2.4.3 it should return correct values if it is live environment without "CHECK_JWT_EXPIRY"', () => {
      // sign with RSA SHA256
      try {
      res = parse(
        'ewoJInR5cGUiOiAiSldUIiwKCSJhbGciOiAiUlMyNTYiCn0.' +
